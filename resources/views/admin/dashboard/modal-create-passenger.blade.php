        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" action="{{ route('admin.passenger.store') }}" method="post" >
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="travel_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Travel Services <span class="text-sm text-red-500">*</span></label>
                        <select id="travel_id" name="travel_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
