...
@section('content')
    ...
    <div class="mt-10 dark:bg-gray-800 rounded-lg p-6">
        <form class="form-horizontal flex flex-col gap-4" id="form-transportations"
            action="{{ route('admin.transportation-trips.store') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-6">
                <div>
                    ...
                    <input type="datetime-local" id="date_departure" name="date_departure"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ old('date_departure') }}" required />
                </div>
                <div>
                    <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                        Date of Return
                ...
                <div>
                    ...
                    <input type="text" id="from_airport" name="from_airport"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="From Airport of transportation trips" value="{{ old('from_airport') }}" maxlength="3"
                        required />
                </div>
                <div>
                    <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                    ...
                    <input type="text" id="to_airport" name="to_airport"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="To Airport of transportation trips" value="{{ old('to_airport') }}" maxlength="3"
                        required />
                </div>
                <div>
                    <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                    ...
                    <div class="grid grid-cols-3">
                        ...
                        @foreach ($transportationStatus as $status)
                            <div class="flex items-center">
                                <input {{ old('status') == $status ? checked : '' }} id="status" type="radio"
