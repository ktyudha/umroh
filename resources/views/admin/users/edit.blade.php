...
@section('content')
    ...
    <div class="mt-10 dark:bg-gray-800 rounded-lg p-6">
        <form class="form-horizontal flex flex-col gap-4" id="form-posts"
            action="{{ route('admin.users.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-5">
                    ...
                    <input type="email" id="email" name="email"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="umroh@gmail.com" value="{{ old('email') ?: $user->email }}" required />
                </div>
            </div>
                    ...
                    @if (auth()->user()->id === $user->id)
                        <div class="mb-5">
                            ...
                            <input type="password" id="old_password" name="old_password"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Password" value="{{ old('old_password') }}" required />
                        </div>
                    @endif
                    <div class="mb-5">
                        <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                    ...
                    <div class="mb-6">
                        ...
                        <div>
                            <select id="role" name="role"
                                ...
                                <option disabled @if (!$user->roles->first() && !old('role')) selected @endif>Choose a role
                                </option>
