...
document.addEventListener("DOMContentLoaded", function () {
    ...
    //             registrationForm.querySelectorAll("[required]");
    ...
    //         const emailField = registrationForm.querySelector(
    //             'input[type="email"]'
    //         );
    ...
    //         const phoneField =
    //             registrationForm.querySelector('input[type="tel"]');
    ...
    //         // Validate checkbox
    //         const agreeCheckbox = registrationForm.querySelector(
    //             'input[type="checkbox"]'
    //         );
